    ...
    <div className="main-blog p-lg-5 p-md-5 p-sm-5 p-2 py-5">
      <div className="card blog-card" style={{ borderRadius: "15px" }}>
        ...
        <div className="card-body">
          ...
          ACE Technologies Hailed by Clutch as a 2022 Leading Software Developer in Pakistan
          </h5>
          <div className="d-flex mt-2">
            ...
            <div className="ps-3">
              <h6 className="fs-14">2022-09-28</h6>
            </div>
          </div>
        </div>
      </div>
      <div
        className="card blog-card mx-lg-3 mx-sm-0"
        style={{ borderRadius: "15px" }}
      >
        <img
          src={require("../../assets/images/1618385988.jpg")}
          className="blog-image"
          alt="blogs"
        />
        <div className="card-body">
          <h5 className="card-text text-start">
          ACE TECHNOLOGIES (PRIVATE) LIMITED – EVERYTHING YOU NEED TO KNOW ABOUT ZAPTA
      ...
      <div className="card blog-card" style={{ borderRadius: "15px" }}>
        ...
        <div className="card-body">
          <h5 className="card-text text-start">
          The Best outsourcing countries for software development in 2021
          </h5>
          <div className="d-flex mt-2">
            <div className="_mt-5">
              <svg
