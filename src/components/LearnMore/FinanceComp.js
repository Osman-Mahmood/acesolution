  ...
  return (
    <div>
      <div class="container-xl">
            <div class="row pt-5">
                <div class="col-sm-12">
                    <h1 class="text-center">Fintech Solutions</h1>
        ...
        <div class="container-xl h-100">
            <div class="row align-items-center h-100">
                <div class="col-sm-6">
                    <h2 class="">Customised Fintech solutions tailored to satisfy customers</h2>
                ...
                <div class="col-sm-6">
                    <img class="img-responsive w-100" src="https://zaptatech.com/public/assets/images/FT1.png" alt="Zapta provides Customised Fintech solutions tailored to satisfy customers" />
                </div>
            </div>
        </div>
        ...
        <div class="container-xl">
            <div class="row justify-content-center align-items-center pt-5">
                ...
                <div class="col-sm-6">
                    <img class="img-responsive w-100" src="https://zaptatech.com/public/assets/images/FT2.png" alt="ZAPTA Technologies provides Custom Fintech Software" />
        ...
        <div class="container-xl">
            ...
            <div class="row pt-5 justify-content-center align-items-center">
                <div class="col-sm-6">
                    <img class="img-responsive w-100" src="https://zaptatech.com/public/assets/images/FT3.png" alt="ZAPTA providing Intelligent CRM Solutions" />
        ...
        <div class="container-xl">
            ...
            <div class="row pt-5 justify-content-center align-items-center">
                ...
                <div class="col-sm-6">
                    <img class="img-responsive w-100" src="https://zaptatech.com/public/assets/images/FT4.png" alt="Zapta builds and deploys RegTech Solutions" />
        ...
        <div class="container-xl">
            ...
            <div class="row pt-5 justify-content-center align-items-center">
                ...
                <div class="col-sm-6">
                    <img class="img-responsive w-100" src="https://zaptatech.com/public/assets/images/FT5.png" alt="Accounting and Financial Management Systems" />
